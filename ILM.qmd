...
We can then introduce a new variable, I, the initial price. The formula thus changes to $P=\frac{\left(M-I\right)C}{A}+I$. With I, the Y-intercept increases but the max price doesn't change. 
...
$P=(M-I)\left(\frac CA\right)^K+I$ to express C in terms of P which is
$C=A \sqrt[K]{\frac{P-I}{M-I}}$ . The derivative of that is then the liquidity
